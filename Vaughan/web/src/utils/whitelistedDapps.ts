...
export const WHITELISTED_DAPPS: WhitelistedDapp[] = [
    ...
    },
    {
        id: '9mm-dex',
        name: '9mm DEX',
        description: 'Leading DEX and Launchpad on PulseChain.',
    ...
    },
    {
        id: '9inch',
        name: '9Inch',
        description: 'Decentralized exchange and yield farming on PulseChain.',
        url: 'https://9inch.io/?chain=pulse&inputCurrency=0x6B175474E89094C44Da98b954EedeAC495271d0F&outputCurrency=0x78a2809e8e2ef8e07429559f15703Ee20E885588',
        icon: '📏',
        category: 'dex',
        chains: [369],
        verified: true,
