 ...
 * 
 * Browser view for interacting with dApps
 * Implements iframe-based dApp integration with EIP-1193 provider
 */
...
interface DappBrowserViewProps {
  /** Initial URL to load */
  initialUrl?: string;
}

export function DappBrowserView({ initialUrl = 'http://localhost:1420/dapp-test-simple.html' }: DappBrowserViewProps) {
